...
console.log("Logout")
  ...
  return (
    <div  style={{backgroundColor:"black",height:"100vh"}}> 
            <div className="india">
              <Row>
           <Col > <Button variant="" onClick={handleShow} className="mobbileaa1"><RiTwitterXLine className="mobileaa2"/></Button></Col>
           <Col > <Pollingpage  className="postmobile"/></Col>
            </Row>
            <Offcanvas show={show} onHide={handleClose}>
                ...
                <Offcanvas.Body>
                    ...
                    <Row><Col><Button variant="" onClick={handleLogout} className="mobilea1"><CgMoreO className="mobilea2" /><span className="mobilea3">Log out</span></Button></Col></Row>
                </Offcanvas.Body>
            </Offcanvas>
        </div>
      <Row>
        <Col md={4}  sm={2} xs={2} lg={4}>
          <div className="india1">
          <Row>
            <Col md={3} sm={2}></Col>
            <Col md={9} sm={10} className="col1">
              ...
              <Row>
                <Col className="b7"><Pollingpage/></Col>
              </Row>
              {user && <div style={{color:"white"}}> Hello, {user.displayName}</div>}
            </Col>
          </Row>
          </div>
        </Col>
            ...
            <Card className="card1">
              <CardBody>
                <Row>
                  ...
                  {/* <Col md={2}>
                    <Button variant="" className="w4">
                      <IoSettingsOutline />{" "}
                    </Button>
                  </Col> */}
                  <hr />
                  {/* {showPollingpage && <Pollingpage />} */}
                </Row>
              </CardBody>
            </Card>
          </Row>
