                      ...
                      <Form onSubmit={handleSubmit}>
                        <Form.Group>
                          <Form.Control
                            ...
                            className="phn"
                            value={state.mobilenumber} onChange={(e) => { handleChange(e); handleInputChange(e) }}
                          />
                        ...
                        <Form.Group>
                          <Form.Control
                            ...
                            className="pass"
                            value={state.password} onChange={(e) => { handleChange(e); handleInputChange(e) }}
                          />
                          <ErrorMessage name='password' component='div' className='text-danger' />{" "}
                          <br />
                        </Form.Group>
                        <Button variant="light" className="twit-signin-btn" type="submit" >
                          Sign in
                        </Button>
