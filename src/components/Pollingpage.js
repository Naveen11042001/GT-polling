import {Row,Col,Card,CloseButton,Button,FloatingLabel,Form, FormControl,} from "react-bootstrap";
    ...
    <Col className="b7">
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>
            <Button variant='' className="draft">Draft</Button>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body> 
        <Col md={11}>
        ...
        <Card className="card2">
                <Card.Body>
                 ...
                 <Row>
            <Col md={7}><button className="imgbutton">{" "}<CiImageOn /></button>
              <button className="imgbutton">{" "}<MdOutlineGifBox />{" "}
              </button>
