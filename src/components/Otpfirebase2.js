      ...
      <h1 className="otpverf">OTP Verification</h1>
        ...
        >
          {({ handleSubmit }) => (
            <Form onSubmit={handleSubmit}>
              <div className="mb-3">
                <label htmlFor="mobile" className="mobile">Enter Mobile Number</label>
                <Field name="mobile" type="text" className="form-control" />
                <ErrorMessage name="mobile" component={Alert} variant="danger" />
              </div>
              <Button type="submit" id="sign-in-button" className="form55">Submit</Button>
            </Form>
          )}
        </Formik>
        ...
        >
          {({ handleSubmit }) => (
            <Form onSubmit={handleSubmit}>
              <div className="mb-3">
                <label htmlFor="otp" className="mobile2">Enter OTP</label>
                <Field name="otp" type="text" className="form-control" />
                <ErrorMessage name="otp" component={Alert} variant="danger" />
              </div>
              <Button type="submit" className="form55">Submit</Button>
            </Form>
          )}
        </Formik>
        </CardBody>
